...
public class RemoveItemFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Remove Item Panel");
	...
	ManageStocksFrame mrf = new ManageStocksFrame();
	mrf.setVisible(true);
	this.dispose();
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
	 ...
	 if(row==-1)
	 {
	   JOptionPane.showMessageDialog(null,"No Products Selected","Not Selected!",JOptionPane.INFORMATION_MESSAGE);
	    return;  
	 }
	 ...
	 try
	 {
	     ...
	     return;
     	     ...
     	     JOptionPane.showMessageDialog(null,"Product Not Deleted!","Failure!",JOptionPane.ERROR_MESSAGE);
	 }
