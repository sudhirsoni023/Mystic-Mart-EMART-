...
public class UpdateReceptionistFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)), "Update Receptionist Panel", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 24), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)), "Receptionist Details", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 24), new java.awt.Color(255, 255, 255))); // NOI18N
   ...
   if(result==0)
   {
    ...
    user.setEmpid(empid);
    boolean result1 = ReceptionistDAO.updateReceptionist(user);
    if(result1)
    {
     JOptionPane.showMessageDialog(null,"Receptionist password Updated Successfully","Success!",JOptionPane.INFORMATION_MESSAGE);
     clearText();
    } 
    else
	 JOptionPane.showMessageDialog(null,"Cannot Update Receptionist password","Error!",JOptionPane.ERROR_MESSAGE);	
    }
    ...
    private void jcEmpIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcEmpIdActionPerformed
		...
		ReceptionistPojo rec = ReceptionistDAO.findReceptionistById(recepId);

		txtEmpName.setText(rec.getEmpname());
		jcEmpId.setSelectedItem(rec.getEmpid());
		txtUserId.setText(String.valueOf(rec.getUserid()));
	    } 
	    catch (SQLException ex) 
	    {
			JOptionPane.showMessageDialog(null,"DB Error","Error!",JOptionPane.ERROR_MESSAGE);
